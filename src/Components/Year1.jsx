...
const Year1 = () => {
  ...
  return (
    <div className="flex flex-col items-center">
      <h1 className="text-2xl font-bold mb-6">Year 1: 17 Days</h1>
      <div className="grid grid-cols-4 md:grid-cols-7 gap-4 grey">
        {daysData.days.map((day) => (
          <div
            key={day.id}
            className={`transition-all duration-75 cursor-pointer flex items-center justify-center rounded-lg ${
              activeDay === day.id ? "bg-blue-400 md:ml-96 ml-52 mt-32 w-96 h-96 absolute" : "bg-gray-200 w-40 h-40 mb-[1rem]"
            }`}
